...
keymap.set("n", "gra", vim.lsp.buf.code_action, { noremap = true, silent = true, desc = "LSP Code Action" })
keymap.set("n", "grr", vim.lsp.buf.references, { noremap = true, silent = true, desc = "LSP References" })
keymap.set("n", "gri", vim.lsp.buf.implementation, { noremap = true, silent = true, desc = "LSP Implementation" })
keymap.set("n", "gO", vim.lsp.buf.document_symbol, { noremap = true, silent = true, desc = "LSP Document Symbol" })
keymap.set("i", "<C-S>", vim.lsp.buf.signature_help, { noremap = true, silent = true, desc = "LSP Signature Help" })
